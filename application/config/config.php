...
|
*/
// if(!in_array($_SERVER['REMOTE_ADDR'], array('192.168.1.183'))) {
// 	$config['base_url'] = 'http://192.168.1.183:8080/garments/';
// } elseif(!in_array($_SERVER['REMOTE_ADDR'], array('127.0.0.1','::1'))) {
// 	$config['base_url'] = 'https://crgarments.ddns.net:8443/garments/';
// } else {
// 	$config['base_url'] = 'http://localhost/garments/';
// }
...
$config['base_url'] = $uri.$_SERVER['HTTP_HOST'].'/creinv/';
